...
export class ClinicPage implements OnInit {
  ...
  getData(id: number) {
    ...
    this.providerSvc.postData('clinic_profile.php', postData).subscribe(
      (data) => {
        if (data != null) {
          this.items = data;
          console.log(data);
          ...
          this.piclink =
            this.providerSvc.imgURL + this.items[0].clinic_id + '/doctor/';
  ...
  getImageData(id: number) {
    ...
    this.providerSvc.postData('clinic_image.php', postData).subscribe(
      (data) => {
        if (data != null) {
          this.itemsImg = data;
          console.log(data);
          ...
          this.imgFilename =
            this.providerSvc.imgURL + this.itemsImg[0].clinic_id + '/clinic/';
  ...
  getBusinessHourData(id: number) {
    ...
    this.providerSvc.postData('business_hour.php', postData).subscribe(
      (data) => {
        if (data != null) {
          this.busitems = data;
